...
public class DownloaderTaskFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // XXX TODO: Start the DownloaderTask
            ...
            mContext.sendOrderedBroadcast(new Intent(
                    ...
                    new BroadcastReceiver() {
                        ...
                        public void onReceive(Context context, Intent intent) {
                            ...
                            // XXX TODO: Check whether or not the MainActivity
                            // received the broadcast

                            if (getResultCode() != MainActivity.IS_ALIVE) {

                                // XXX TODO: If not, create a PendingIntent using
                                ...
                                // XXX TODO: Set the notification View's text to
                                ...
                                // XXX TODO: Use the Notification.Builder class to
                                ...
                                // XXX TODO: Send the notification

                                NotificationManager mgr =
                                        (NotificationManager) mContext.getSystemService(Context.NOTIFICATION_SERVICE);

                                mgr.notify(MY_NOTIFICATION_ID, notification);
